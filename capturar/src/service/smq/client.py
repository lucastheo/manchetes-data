...
class SmqCliente:
    ...
    def envia(self,mensagem='', nome_fila="padrao", lista_elementos_grupo=list() ):
    ...
    def __recebe(self, nome_fila, elemento_grupo):
        ...
        return SmqCliente.SmqClienteRetornoConsumo(self._url,
                                                   result.text if self.__recebe_status_valido(result) else None)
