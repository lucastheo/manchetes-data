# O arquivo ./texto/json.text -> resonsável em ter os jsons com as insformações do processo 
#
#
#Exemplo do arquivo ./text/json.text
#{
#  "url":{
#           "data":{
#                   "text":""
...
import sys
sys.path.append("../")
from down_html import lib_data_base_control
import sys
import json
import re
